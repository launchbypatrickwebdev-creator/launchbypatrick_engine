...
serve(async (req) => {
  ...
  try {
    ...
    try {
      ...
      console.error("Failed to render inline logo:", e);
    }
    ...
    page.drawText("URL: echolevel.vercel.app/sentinel/connect", { x: 60, y: y + 20, size: 9, font: fontBold, color: emeraldGreen });
    ...
    page.drawText("Ibadan, Oyo State, Nigeria · echolevel.vercel.app/sentinel/connect", { x: 40, y: 18, size: 8, font: fontRegular, color: rgb(0.6, 0.6, 0.6) });
